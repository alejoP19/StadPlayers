            ...
            <div class="col-lg-10">
                <div class="card shadow-lg border-0 rounded-lg justify-content-center" style="margin-top: 30%;">
                    ...
                    <div class="card-body text-black" style="background-color: #B7C7C7;">
                        <form action="../../Controllers/EstadisticasController.php?c=5" method="POST"
                            onsubmit="return validateForm()">
                            <div class="card d-flex justify-content-center py-3 px-3 fs-3"
                                style="background-color: #009392;">
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <div class="col mt-4">
                                            <a href="verEquipos.php" class="btn btn-warning btn-block"
                                                id="btn_equipos">Ver equipos</a>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="col mt-4">
                                            <a href="verCopas.php" class="btn btn-warning btn-block"
                                                id="btn_equipos">Ver copas</a>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="col mt-4">
                                            <a href="verPaises.php" class="btn btn-warning btn-block"
                                                id="btn_equipos">Ver paises</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <div class="col mt-4">
                                            <a href="verLiga.php" class="btn btn-warning btn-block" id="btn_equipos">Ver
                                                tipos ligas</a>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <label for="agre_tipo_partido" class="text-center">Agregar Tipo Partido</label>
                                        <input type="text" name="agre_tipo_partido" id="agre_tipo_partido"
                                            class="rounded w-100">
                                        <div class="col mt-4">
                                            <a href="verTipoPartido.php" class="btn btn-warning btn-block"
                                                id="btn_equipos">Ver tipos de partido</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
