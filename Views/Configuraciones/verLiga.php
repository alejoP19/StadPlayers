                    ...
                    <table class="table table-dark table-striped text-info fs-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->nombre ?></td>
                                <td>
                                    <a class="btn btn-danger" id="deleteli"
                                        href="../../Controllers/EstadisticasController.php?c=8"
                                        data-id="<?= $row->id ?>" onclick="obtenerli(event); return false;">Eliminar</a>
                                </td>
                            </tr>
                            <?php
                                    $pos++;
