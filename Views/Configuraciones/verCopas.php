                    ...
                    <table class="table table-dark table-striped text-info fs-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->nombre ?></td>
                                <td>
                                    <a class="btn btn-danger" id="deleteco"
                                        href="../../Controllers/EstadisticasController.php?c=10"
                                        data-id="<?= $row->id ?>" onclick="obtenerco(event); return false;">Eliminar</a>
                                </td>
                            </tr>
                            <?php
                                    $pos++;
