                    ...
                    <table class="table table-dark table-striped text-info fs-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->equipo ?></td>
                                <td>
                                    <a class="btn btn-danger" id="deletequi"
                                        href="../../Controllers/EstadisticasController.php?c=9"
                                        data-id="<?= $row->id ?>"
                                        onclick="obtenerqui(event); return false;">Eliminar</a>
                                </td>
                            </tr>
                            <?php
                                    $pos++;
