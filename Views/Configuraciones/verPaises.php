                    ...
                    <table class="table table-dark table-striped text-info fs-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger" id="deletepa"
                                        href="../../Controllers/EstadisticasController.php?c=7"
                                        data-id="<?= $row->id ?>" onclick="obtenerid(event); return false;">Eliminar</a>
                                </td>
                            </tr>
                            <?php
                                    $pos++;
